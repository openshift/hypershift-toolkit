...
#
# ORIGINAL in https://github.com/openshift/origin/tree/master/test/extended/conformance-k8s.sh
# This version skips the code to mark masters as unschedulable.
